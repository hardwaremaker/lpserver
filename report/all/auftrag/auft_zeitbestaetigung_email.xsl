...
<xsl:template match="belegnummer">hiermit erhalten Sie für Ihre Unterlagen die Zeitbestätigung zu Auftrag <xsl:value-of select="."/>.

Die aufgeführten Zeiten wurden von <xsl:value-of select="/mail/bearbeiter_titel"/>&#160;<xsl:value-of select="/mail/bearbeiter_vorname"/>&#160;<xsl:value-of select="/mail/bearbeiter_nachname"/> erbracht.


<!--
Der Text <xsl:value-of select="/mail/text"/>&lt;brimborium&gt;<xsl:value-of select="."/> hat auch seine guten Seiten
<xsl:text>
</xsl:text>
 -->
...
&lt;p&gt;&lt;b&gt;i.A. <xsl:value-of select="/mail/bearbeiter"/>&lt;/b&gt;&lt;/p&gt;

&lt;p&gt;HELIUM V IT-Solutions GmbH&lt;br&gt;
&lt;br&gt;
Nordstra&#223;e 4&lt;br&gt;
A-5301 Eugendorf b. Salzburg&lt;br&gt;
&lt;br&gt;
Internet: http://www.HeliumV.com&lt;br&gt;
E-Mail:   <xsl:value-of select="/mail/bearbeiter_email"/>&lt;br&gt;
Tel.:     +43 (0)6225/28088-0&lt;br&gt;
Fax:      +43 (0)6225/28088-99&lt;br&gt;
&lt;/p&gt;
</xsl:template>
</xsl:stylesheet>
