...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="mail">
		...
		<xsl:apply-templates select="kopftext"/>
...
im Anhang übersenden wir dir die<xsl:value-of select="/mail/bezeichnung"/>&#160;<xsl:value-of select="."/> und den Gehaltsbeleg.
	</xsl:template>
	<xsl:template match="fusstext">

Vielen Dank für dein Engagement in unserem Unternehmen
...
<xsl:value-of select="/mail/bearbeiter_vorname"/>&#160;<xsl:value-of select="/mail/bearbeiter_nachname"/>
Personalabteilung

HELIUM 5 ERP-Software für den nachhaltigen Unternehmenserfolg	
	</xsl:template>
</xsl:stylesheet>


<!-- kurze Beschreibung
Info zu Zeilenumbrüchen, Betreff, Absender, Anhang siehe unten.
