...
<xsl:template match="text"><xsl:value-of select="/mail/text"/>
<!--
...
<xsl:template match="fusstext">
	...
	<p><strong>i.A. <xsl:value-of select="/mail/bearbeiter"/></strong></p>
	<p>HELIUM V IT-Solutions GmbH<br /> <br />Dürnbichlerstraße 5<br /> A-5301 Eugendorf b. Salzburg<br /> <br /> Internet: http://www.HeliumV.com<br /> E-Mail: <xsl:value-of select="/mail/bearbeiter_email"/><br /> Tel.: +43 (0)6225/28088-0<br /> Fax: +43 (0)6225/28088-99</p>
	<!-- </HeliumV_HTML> -->
</xsl:template>
</xsl:stylesheet>
