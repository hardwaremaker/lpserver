...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="mail">absender@email.at</xsl:template>
</xsl:stylesheet>


<!-- kurze Beschreibung
Dies dient zur Übersteuerung des Absenders für den EMail Versand des jeweiligen
Dokumentes. Sodass z.B. die Rechnung immer von rechnung@ ... versandt wird, egal
wer es versendet.
Die Parameter/Variablen siehe mail.xsl

aus dem SP 1246,13

Die Datei im allgemein-Verzeichnis muss heißen: absender.xsl
Dateien für spezielle Reports müssen heißen zb.: rech_rechnung_absender.xsl
Beispiel von eng. AB
