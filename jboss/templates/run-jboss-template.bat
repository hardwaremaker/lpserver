...
rem $Id: run-jboss-template.bat,v 1.1 2008/07/24 09:31:09 victor Exp $
...
set JAVA_OPTS=%JAVA_OPTS% #{jvm.args.server} -Dsun.rmi.dgc.client.gcInterval=3600000 -Dsun.rmi.dgc.server.gcInterval=3600000
